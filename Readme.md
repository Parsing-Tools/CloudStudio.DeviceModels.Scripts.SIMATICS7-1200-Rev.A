...
# Configuration Script – SIMATIC S7-1200 - Rev. A

This **Configuration** script is designed for the **SIMATIC S7-1200** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – SIMATIC S7-1200 Rev. A

Este script de **Configuration** está diseñado para el modelo **SIMATIC S7-1200** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
